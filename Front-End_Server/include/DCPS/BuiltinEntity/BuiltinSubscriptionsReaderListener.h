#ifndef INCLUDE_DCPS_BUILTINENTITY_BUILTINSUBSCRIPTIONSREADERLISTENER_H_
#define INCLUDE_DCPS_BUILTINENTITY_BUILTINSUBSCRIPTIONSREADERLISTENER_H_
...
namespace CNU_DDS
{
	class CNU_DDS_DLL_API BuiltinSubscriptionsReaderListener: public DataReaderListener
	{
	public:
...
#endif
#endif /* INCLUDE_DCPS_BUILTINENTITY_BUILTINSUBSCRIPTIONSREADERLISTENER_H_ */
